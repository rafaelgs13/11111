(function($){
	var DrSlider = function(element, options){
		...
		this.options = {
			...
			navigationHoverColor: '#2E2E2E',
			navigationHighlightColor: '#2E2E2E',
	...
	DrSlider.prototype = {
		...
		_attachControl: function(){
			...
			this.$ele_in.append('<div class="button-previous button-slider"><img src="images/seta.png"></div>');
			this.$ele_in.append('<div class="button-next button-slider"><img src="images/seta_next.png"></div>');
